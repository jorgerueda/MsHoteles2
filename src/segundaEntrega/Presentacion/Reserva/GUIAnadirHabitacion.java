 ...
 * 
 */
package segundaEntrega.Presentacion.Reserva;
...
public class GUIAnadirHabitacion extends javax.swing.JFrame {

	/**
	 * Creates new form GUIAnadirHabitacion
	 */
	static private GUIAnadirHabitacion anadirHabitacion;

	/** Creates new form NuevaReserva */
	private GUIAnadirHabitacion() {
		initComponents();
	}

	static public GUIAnadirHabitacion obtenerInstancia() {
		if (anadirHabitacion == null) {
			anadirHabitacion = new GUIAnadirHabitacion();
		}

		return anadirHabitacion;
	}
	...
	private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		ControladorImp.getInstancia().execute(Evento.ANADIR_HABITACION, transferReserva);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(GUIAnadirHabitacion.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new GUIAnadirHabitacion().setVisible(true);
			}
		});
	}
